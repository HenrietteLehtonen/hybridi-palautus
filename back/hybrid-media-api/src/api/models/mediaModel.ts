...
import {MediaItem, UserLevel} from '../../../../hybrid-types/src/DBTypes';
import promisePool from '../../lib/db';
import {MessageResponse} from '../../../../hybrid-types/src/MessageTypes';
...
const postMedia = async (
  ...
  const sql = `INSERT INTO MediaItems (user_id, filename, filesize, media_type, title, description, ingredients, recipe)
               VALUES (?, ?, ?, ?, ?, ?, ?,?)`;
  const params = [
    user_id,
    filename,
